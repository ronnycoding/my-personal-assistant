...
AppleScript skills for macOS Calendar automation including event reading, conflict detection, and meeting time suggestions.
...
🚧 **Not Yet Implemented** - See issues #8, #9, #10 for specifications.
